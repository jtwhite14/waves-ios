...
class WaveAvatarView : MKMapView, MKMapViewDelegate {
    ...
    func setStartingRegion(coordinates:CLLocationCoordinate2D) {
        let region = MKCoordinateRegionMakeWithDistance(coordinates, 7000, 7000)
    ...
    func mapView(aMapView: MKMapView!, viewForAnnotation annotation: MKAnnotation!) -> MKAnnotationView! {
        ...
        startingView.image = UIImage(named: "avatar-map-icon")
        return startingView
    }
